...
//base url
String url = 'https://supertaxi.in/public/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey =
    (platform == TargetPlatform.android) ? 'AIzaSyDc60dcf4WH97EvrkRclSOwfKXumPWMgjs' : 'AIzaSyDc60dcf4WH97EvrkRclSOwfKXumPWMgjs';
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "SuperTaxi Pilot will continue to receive your location in background",
