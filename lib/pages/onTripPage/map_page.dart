  ...
  getLocs() async {
    ...
    if (permission == geolocator.LocationPermission.denied ||
      ...
      if (serviceEnabled == true) {
        ...
        markerIcon4 =
          await getBytesFromAsset('assets/images/auto.png', 80);
        ...
        if (mounted) {
          setState(() {
            ...
            pinLocationIcon4 = BitmapDescriptor.fromBytes(markerIcon4);
                ...
                Marker(
                    ...
                    icon: (userDetails['vehicle_type_icon_for'] == 'motor_bike')
                        ...
                        : (userDetails['vehicle_type_icon_for'] == 'taxi')
                            ? pinLocationIcon
                            : (userDetails['vehicle_type_icon_for'] == 'auto')
                            ? pinLocationIcon4
                            : pinLocationIcon3,
            ...
            builder: (context, value, child) {
              ...
              if (navigated == false) {
                ...
                if (myMarkers
                  ...
                  else if (userDetails['vehicle_type_icon_for'] != 'auto' &&
                      myMarkers
                              .firstWhere((element) =>
                                  element.markerId == const MarkerId('1'))
                              .icon ==
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (((userDetails['vehicle_type_id'] != null) ||
                                                                        ...
                                                                        if (userDetails['active'] ==
                                                                          ...
                                                                          //   if (await DashBubble.instance.hasOverlayPermission() == false) {setState(() {
